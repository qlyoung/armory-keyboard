...
#
# This script expects to be run on the Debian Jessie
# base image provided by Inverse Path. Adapting it to
...
# setup hid parameters for the keyboard device
